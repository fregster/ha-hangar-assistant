...
class NOTAMCriticality(Enum):
    ...
    # Significant impact (nav aid failures, restricted areas)
    HIGH = "high"
    # Moderate impact (lighting issues, partial restrictions)
    MEDIUM = "medium"
    # Informational (construction, exercises, minor changes)
    LOW = "low"
...
Q_CODE_SUBJECTS = {
    ...
    # Services - MEDIUM
    # QFAXX: Already defined above as CRITICAL (Aerodrome closed)
...
def sort_notams_by_criticality(
        notams: list[Dict[str, Any]]) -> list[Dict[str, Any]]:
